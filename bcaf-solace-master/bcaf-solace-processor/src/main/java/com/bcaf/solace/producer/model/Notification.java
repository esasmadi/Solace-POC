...
public class Notification implements Serializable {
    ...
    public Notification(String from, String to, String cc, String subject, String body, String attachmentName, String attachmentDescription, String attachmentType, String attachmentBody) {
        this.From = from;
        this.To = to;
        this.Cc = cc;
